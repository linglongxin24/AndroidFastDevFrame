...
import cn.bluemobi.dylan.httputils.HttpResponse;
import cn.bluemobi.dylan.httputils.LoadingDialog;
import cn.bluemobi.dylan.httputils.NetworkUtil;
                ...
                .subscribe(new Subscriber<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody result) {
                        ...
                        try {
                            ...
                            String msg = JsonParse.getValue(jsonBean, JsonParse.getJsonParse().getMsg());
                            int code = Integer.parseInt(JsonParse.getValue(jsonBean, JsonParse.getJsonParse().getCode()));
